...
function FooterContacts() {
  const contactsLink = footerLinks.find((link) => link.path === '/contacts');

  return (
    <div className={styles.footer__contacts}>
      <NavLink
        className={({ isActive }) =>
          [styles.footer__contacts_title, isActive ? styles.footer__contacts_title_active : '']
            .filter(Boolean)
            .join(' ')
        }
          ...
          <div className={styles.footer__contacts_dl_row}>
            ...
            <dd className={styles.footer__contacts_dd}>
              <a
                ...
                className={styles['footer__contacts_info_mail-link']}
              >
                rdk-pristan@mail.ru
              </a>
            </dd>

...
export const ListExternalLinkCards: ListExternalLinkCardsItem[] = [
  {
    image: SVOi,
    link: 'https://nt-kuzbass.ru/afisha/detail.php?ID=991',
    title: 'Поддержка участников специальной военной операции и их семей',
  },
  ...
  {
    image: ukmr,
    link: 'https://markultura.ucoz.com/',
    title: '	Управление культуры Мариинского муниципального округа',
  },
  {
    image: departament,
    link: 'https://mincult-kuzbass.ru/',
    title: 'Департамент культуры и национальной политики Кемеровской области',
  },
  { image: gosuslugi, link: 'https://www.gosuslugi.ru/', title: 'Портал государственные услуги' },
  {
    image: opros,
    link: 'https://forms.mkrf.ru/e/2579/xTPLeBU7/?ap_orgcode=550160326',
    title: 'Опрос',
  },
